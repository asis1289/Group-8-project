...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $conn->prepare("SELECT username FROM employees WHERE username = ? AND password = ?");
    ...
    if ($employee) {
        ...
        header("Refresh: 2; url=employee_dashboard.php"); // Redirect after 2 seconds
    } else {
...
<head>
    ...
    <title>Employee Login - Hospital Management System</title>
    <style>
        ...
        <div class="right-menu">
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="employee_login.php" class="active">Login as Employee</a>
